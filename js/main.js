// Esperar a que cargue el DOM para ejecutar los dibujos
...
function draw1() {
    ...
    ctx.fillStyle = "rgba(226, 138, 238, 1)";
...
function draw6() {
    ...
    for (let i = 0; i < 4; i++) {
        for (let j = 0; j < 3; j++) {
            ...
            ctx.arc(x, y, 20, 0, endAngle, counterclockwise);
            if (i > 1) ctx.fill(); else ctx.stroke();
        }
    }
}

// 7. Curvas cuadráticas
function draw7() {
